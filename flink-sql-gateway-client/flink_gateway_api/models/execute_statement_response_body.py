...
T = TypeVar("T", bound="ExecuteStatementResponseBody")
...
class ExecuteStatementResponseBody:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        execute_statement_response_body = cls(
            operation_handle=operation_handle,
        )

        execute_statement_response_body.additional_properties = d
        return execute_statement_response_body
