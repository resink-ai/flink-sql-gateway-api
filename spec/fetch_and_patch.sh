...
wget https://nightlies.apache.org/flink/flink-docs-master/generated/rest_v2_sql_gateway.yml -O rest_v2_sql_gateway_2_1.yml
wget https://nightlies.apache.org/flink/flink-docs-master/generated/rest_v3_sql_gateway.yml -O rest_v3_sql_gateway_2_1.yml
